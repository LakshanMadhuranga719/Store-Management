...
{
    public partial class add_account_SK : Form
    {
        public add_account_SK()
        {
            InitializeComponent();
        }
        ...
        private void btnsave_Click(object sender, EventArgs e)
        {
            if (txtUsername.Text != "" && txtAddress.Text != "" && txtemail.Text != "" && txtPhoneNO.Text != "" && txtpw.Text != "")
            {
                ...
                con.Open();
                cmd.CommandText = "insert into logintable_store_keeper (Username,Address,E_mail,Phone_NO,Password) values('" + UName + "','" + Address + "','" + Email + "'," + PhoneNO + ",'" + pw + "')";
                cmd.ExecuteNonQuery();
                con.Close();
