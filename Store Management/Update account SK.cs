...
{
    public partial class Update_account_SK : Form
    {
        public Update_account_SK()
        {
            InitializeComponent();
        }

        private void Update_account_SK_Load(object sender, EventArgs e)
        {
            ...
            cmd.CommandText = "select* from logintable_store_keeper";
        ...
        private void txtUname_TextChanged(object sender, EventArgs e)
        {
            if (txtUname.Text != "")
            {
                ...
                cmd.CommandText = "select* from logintable_store_keeper where Username LIKE '" + txtUname.Text + "%'";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            cmd.CommandText = "select* from logintable_store_keeper where SK_User_ID= " + AID + "";
        ...
        private void blnupdate_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Data Will be Updated. Conform?", "Success", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
            {
                ...
                cmd.CommandText = "update logintable_store_keeper set Username = '" + Uname + "',Address = '" + Address + "',E_mail ='" + email + "' , Phone_NO =" + PNO + " , Password ='" + PW + "' where SK_User_ID =" + rowid + "";
        ...
        private void btndelete_Click(object sender, EventArgs e)
        {
            if (MessageBox.Show("Data Will be Deleted. Conform?", "Conformation Dialog", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning) == DialogResult.OK)
            {
                ...
                cmd.CommandText = "delete from logintable_store_keeper where SK_User_ID =" + rowid + "";
